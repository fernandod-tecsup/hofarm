              ...
              <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      <img class="" src="Vistas/images/index/ciudad_inteligente.jpg" alt="First slide">
                    </div>
                    <div class="carousel-item">
                      <img class="" src="Vistas/images/index/smart_app.jpg" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                      <img class="" src="Vistas/images/index/logo_ares.jpg" alt="Third slide">
                    </div>
                  </div>
